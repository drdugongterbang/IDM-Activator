...
:: JANGAN EDIT/MODIFIKASI SCRIPT INI atau bisa berakibat FATAL
:: JANGAN DIJUAL ULANG
...
%nceline%
echo Aktivasi tidak bisa dilakukan Tanpa Akses Administrator Komputer.
echo Ulangi buka file ini, dengan cara dobel klik filenya. Saat muncul pertanyaan, di klik YES.
goto done2
)
...
call :_color2 %_White% "        " %_Green% "Aktivator IDM V1.0"
echo:          _____________________________________________   
echo: 
echo:          made by dugong_terbang
echo:          _____________________________________________   
echo:                                                          
echo:          [1] Aktivasi IDM Anda                                
echo:          [2] Reset IDM Trial (Jika mengalami Fake Serial)
echo:          _____________________________________________   
echo:                                                          
call :_color2 %_White% "          [3] Toggle Windows Firewall  " %_col% "[%_status%]"
echo:          _____________________________________________   
echo:                                                          
echo:          [4] Bacaan penting                                      
echo:          [5] Kunjungi laman github                                    
echo:          [6] Keluar                                        
...
if not exist "!IDMan!" (
call :_color %Red% "IDM [Internet Download Manager] belum terinstal di komputer kamu."
echo Instal IDM dari link yang kami kasih
goto done
)
...
echo %line%
echo:
call :_color %Green% "IDM Berhasil diaktivasi."
echo:
call :_color %Gray% "Jika muncul Fake Serial, Ulangi jalankan Aktivasi Lagi, setelah itu tidak akan muncul lagi."
goto done
)
...
echo Tekan tombol apapun di keyboard untuk exit...
pause >nul
exit /b
...
start https://github.com/drdugongterbang
goto MainMenu
...
echo %line%
echo:
call :_color %Red% "GAGAL AKTIVASI IDM, coba lagi atau tekan opsi 2"
exit /b
...
If not defined name set name=dugongterbang
...
_________________________________
 ...
 - IDM BISA DIUPDATE SETELAH AKTIVASI.

 - Jika sudah aktivasi/update, kemudian IDM minta diaktivasi lagi maka ulangi saja langkah aktivasi (jarang terjadi).
...
_________________________________
 ...
 - RESET IDM agar bisa dipakai lagi sebagai TRIAL 30 hari
 
 - Bisa dipakai untuk FIX masalah FAKE SERIAL NUMBER DI IDM
...
_________________________________
 ...
 - Hanya untuk Windows 7/8/8.1/10/11 dam windows Server.
...
_________________________________
   ...
   - Jangan di klik kanan run as administrator, tapi HARUS di dobel klik biasa, nanti pilih YES saat ditanya
   - Jika aktivasi GAGAl karena keterangan Access Denied, artinya ada masalah dengan user Windows anda
     Buat User baru di windows, kasih akses Administrator, aktivasi IDM dari user baru
...
_________________________________
   ...
   - Now install the IDM and use the activate option in this script if failed then,
     ...
     - If you are still facing any issues, please chat (mentioned below on this page).
